...
internal class CreateCustomerPreferencesHandlerTest(@Autowired private val webTestClient: WebTestClient) {
    ...
    fun `POST customers preferences should return OK when customer preferences successfully created for authorized user with valid input`() {
        // Given
    ...
    @Test
    @Throws(Exception::class)
    fun `POST customers preferences should return OK when customer preferences successfully created for authorized user with valid input and null language`() {
        // Given
        val accessToken = fakeTokenGenerator.generateNotExpiredSignedToken("Ane", 3600, "customer.write")
        val toCreate = CreateCustomerPreferencesRequest(
            seatPreference = NO_PREFERENCE,
    ...
    @Test
    @Throws(Exception::class)
    fun `POST customers preferences should return 400 bad request when language is not valid`() {
        // Given
    ...
    @Test
    fun `POST customers preferences should return 403 forbidden when not authenticated user`() {
    ...
    @Test
    fun `POST customers preferences should return 403 forbidden when authenticated user with insufficient privileges`() {
        // Given
    ...
    @Test
    fun `POST customers preferences should return 400 bad request when seat preference is null`() {
        // Given
        val accessToken = fakeTokenGenerator.generateNotExpiredSignedToken("trotro", 3600, "customer.write")
        val toCreate =  """
                        { "classPreference":"2",
    ...
    @Test
    fun `POST  customerspreferences should return 400 bad request when classPreference is not valid`() {
        // Given
        val accessToken = fakeTokenGenerator.generateNotExpiredSignedToken("trotro", 3600, "customer.write")
        val toCreate = CreateCustomerPreferencesRequest(
            seatPreference = NEAR_CORRIDOR,
    ...
    @Test
    fun `POST customers preferences should return 400 bad request when classPreference is not valid`() {
        // Given
        val accessToken = fakeTokenGenerator.generateNotExpiredSignedToken("trotro", 3600, "customer.write")
        val toCreate = CreateCustomerPreferencesRequest(
            seatPreference = NEAR_CORRIDOR,
    ...
    @Test
    fun `POST customers preferences should return 400 bad request when profileName does not respect pattern`() {
        // Given
        val accessToken = fakeTokenGenerator.generateNotExpiredSignedToken("trotro", 3600, "customer.write")
        val toCreate = CreateCustomerPreferencesRequest(
            seatPreference = NEAR_WINDOW,
    ...
    @Test
    fun `POST customers preferences should return 400 bad request when profileName is empty`() {
        // Given
        val accessToken = fakeTokenGenerator.generateNotExpiredSignedToken("trotro", 3600, "customer.write")
        val toCreate = CreateCustomerPreferencesRequest(
            seatPreference = NEAR_WINDOW,
    ...
    @Test
    fun `POST customers preferences should return 400 bad request when profileName is too long`() {
        // Given
        val accessToken = fakeTokenGenerator.generateNotExpiredSignedToken("trotro", 3600, "customer.write")
        val toCreate = CreateCustomerPreferencesRequest(
            seatPreference = NEAR_WINDOW,
