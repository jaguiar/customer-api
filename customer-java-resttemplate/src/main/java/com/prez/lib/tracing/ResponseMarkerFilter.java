 ...
 */
public class ResponseMarkerFilter implements ClientHttpRequestInterceptor {
  ...
  public ClientHttpResponse intercept(HttpRequest request, byte[] body, ClientHttpRequestExecution execution)
    ...
    try {
      ...
      int result = resp.getStatusCode().is5xxServerError() ? 0 : 1;
      ...
      summary.record(0);
      LOGGER.error("Call to webService {} was KO, for request : {} {}", request.getMethod(),
